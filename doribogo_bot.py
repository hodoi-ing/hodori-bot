...
수집된 3대 테크 크리에이터(@choi.openai, @unclejobs.ai, @h2smusic)의 게시글 중 가장 반응 좋은 핵심 이슈를 디스코드 모바일 화면에서 한눈에 10초 만에 읽히도록 깔끔하게 정리하세요.
장황한 설명이나 사족은 일절 빼고, 볼드체와 핵심 불릿 2줄로 요약하세요.

오늘 날짜: {today}
수집된 최신 포스트:
{context}

출력 형식 (이 형식을 그대로 지키세요):

1️⃣ **@choi.openai ┃ [다룬 이슈 제목]**
• **핵심:** [무슨 소식/주장인지 1줄 요약]
• **포인트:** [실무에서 왜 중요한지 또는 어떻게 쓰는지 1줄 요약]
🔗 **[원문 바로가기](원문링크)**

2️⃣ **@unclejobs.ai ┃ [다룬 이슈 제목]**
• **핵심:** [무슨 소식/주장인지 1줄 요약]
• **포인트:** [실무에서 왜 중요한지 또는 어떻게 쓰는지 1줄 요약]
🔗 **[원문 바로가기](원문링크)**

3️⃣ **@h2smusic ┃ [다룬 이슈 제목]**
• **핵심:** [무슨 소식/주장인지 1줄 요약]
• **포인트:** [실무에서 왜 중요한지 또는 어떻게 쓰는지 1줄 요약]
🔗 **[원문 바로가기](원문링크)**
"""
